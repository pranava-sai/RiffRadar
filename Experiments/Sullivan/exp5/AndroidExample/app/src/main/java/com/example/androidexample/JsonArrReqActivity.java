...
//    private static final String URL_JSON_ARRAY = "https://jsonplaceholder.typicode.com/users";
    private static final String URL_JSON_ARRAY = "https://7cec179d-f84e-4fb5-9284-ff611196d213.mock.pstmn.io/concerts";
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                ListItemObject item = new ListItemObject(name, price, time);
                                adapter.add(item);
