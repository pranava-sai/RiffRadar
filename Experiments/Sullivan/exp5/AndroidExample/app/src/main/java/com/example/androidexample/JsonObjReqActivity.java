...
public class JsonObjReqActivity extends AppCompatActivity {
    ...
    private TextView nameView, priceView, timeView;

//    private static final String URL_JSON_OBJECT = "https://jsonplaceholder.typicode.com/users/1";
    private static final String URL_JSON_OBJECT = "https://7cec179d-f84e-4fb5-9284-ff611196d213.mock.pstmn.io/concert/0";
